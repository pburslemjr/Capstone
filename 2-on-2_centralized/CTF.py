...
class CTF(gym.Env):
	...
	def step(self, actions):
		...
		unshaped_rew = self.reward(local_rewards, global_rewards)
		rew_frac = 1
		shaped_rew = rew_frac * shaped_rew
		all_rew = unshaped_rew + shaped_rew
		return [self.obs, all_rew, done, {"shaped":shaped_rew, "unshaped":unshaped_rew}]
